...
*FPT_TST_EXT.1.2* The TSF shall respond to [selection: _all failures, [assignment: list of failures detected by self-tests]_] by [selection: _entering a maintenance mode, rebooting, [assignment: other methods to enter a secure state]_].
