...
|TLS 1.3 without TLS 1.2 or TLS 1.1 | Shall not select | Shall select at least one  | 
|TLS 1.3 with TLS 1.2 or TLS 1.1 |See the following rows |Shall select at least one- see the following rows for additional instructions |
