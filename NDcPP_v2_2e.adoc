...
*FCS_TLSC_EXT.3 TLS Client Support for renegotiation (TLS 1.2 only)*
...
*FCS_TLSS_EXT.3 TLS Server Support for renegotiation (TLS 1.2 only)*
...
_The TOE shall not negotiate sessions using any of the SSL versions as well as TLS 1.0._
