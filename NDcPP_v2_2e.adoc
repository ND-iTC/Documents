...
The following list contains all DTLS-/TLS-related ciphersuites supported by this cPP for TLSv1.1 and/or TLSv1.2.
...
_List 1: List of supported TLS-related ciphersuites for TLSv1.1 and/or TLSv1.2_
