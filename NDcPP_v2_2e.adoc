...
* _IKEv2 as defined in RFC 7296 and_ [selection: _with no support for NAT traversal, with mandatory support for NAT traversal as specified in RFC 7296, section 2.23)_], _and_ [selection: _no other RFCs for hash functions, RFC 4868 for hash functions_]
...
* _IKEv2 as defined in RFCs 7296 [selection: with no support for NAT traversal, with mandatory support for NAT traversal as specified in RFC 7296, section 2.23)_]_, and_ [selection: _no other RFCs for hash functions, RFC 4868 for hash functions]_].
