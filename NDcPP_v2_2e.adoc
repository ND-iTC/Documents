...
* [.underline]#Early data extension#
...
*FCS_DTLSS_EXT.1.9* The TSF shall prohibit the use of the following extensions: [assignment: [.underline]#list of prohibited DTLS extensions#].
