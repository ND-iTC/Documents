...
_If "ability to view locally" is selected in FAU_STG_EXT.1.6, then FAU_SAR.1 from Appendix B must be included in the ST._
...
_If LMS or XMSS is selected, then FCS_COP.1/XOF from Appendix B must be included._ 
