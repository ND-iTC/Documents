...
<<table-4-fcs-ckm11-skg,Table 4: Allowed choices for FCS_CKM.1.1/SKG>>

<<table-5-fcs-ckm71,Table 5: Allowed choices for FCS_CKM_EXT.7.1>>
...
<<table-19-fcs-ckm71ext,Table 19: Allowed choices for FCS_CKM_EXT.7.1>>
...
To evaluate a vND as a pND means:
...
Note that in the case where no registration channel is required (i.e., the 'joiner' and 'gatekeeper' are directly configured (Figure 14)), enablement is implied as part of this direct configuration process.
...
[[table-19-fcs-ckm71ext]]_Table 19: Allowed choices for FCS_CKM_EXT.7.1_
