...
<<table-17-fcs-ckm11-skg,Table 17: Allowed choices for FCS_CKM.1.1/SKG>>
...
|FCS_CKM.1/SKG |Cryptographic Key Generation - Symmetric Key |Feature Dependent
...
[[table-8-fcs-rbg11]]_Table 8: Allowed choices for FCS_RBG.1.1
...
This is a selection-based SFR, to be included in the ST if “generate 256 bit-based pre-shared keys via FCS_RBG.1” is selected in FIA_PSK_EXT.1.2, or as deemed necessary by claimed PP Modules.
...
[[table-17-fcs-ckm11-skg]]_Table 17: Allowed choices for FCS_CKM.1.1/SKG_
...
_If the TOE is capable of generating PSKs via the DRBG, then FCS_CKM.1/SKG must be included._
