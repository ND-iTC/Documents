...
Part 1: Introduction and general Mmodel, +
...
* Conforms to the requirements of Common Criteria 2002, Revision 1
...
//Why v2.1? NIAP only have 2.0 on their web site //
...
The supporting document defines the evaluation methods and activities for this cPP and has been developed in accordance [CC4]The suporting document can be found at https://github.com/ND-iTC/Documents.
...
. For each auditavle event type, based on the auditable event definitions of the functional components included in the **c**PP, PP-Module, functional package or ST, _information specified in column three of_ _Table 2_.
...
// The FCS_SFRs will be edited by RW //
...
#Table 3: Asymmetric Cryptographic Key Generation#
...
_The option "FFC Schemes using “safe-prime” groups that meet the following: ‘NIST Special Publication 800-56A Revision 3, “Recommendation for Pair-Wise Key Establishment Schemes Using Discrete Logarithm Cryptography” and [selection: groups listed in RFC 3526, groups listed in RFC 7919]." shall be read as 'the TSF performs Key Agreement as specified in SP800-56Ar3', but not necessarily adhering to the protocol restrictions for these groups, as indicated in Appendix D, tables 25 and 26._ _Instead, the use of those methods for particular protocols is in accordance with the SFR for the specific protocols. 
...
#Table 5: Signature Verification#
...
*FTA_TAB.1.1:* Before establishing a *administrative* user session the _TSF_ shall display *a* *Security Administrator-specified advisory notice and consent warning regarding use of the TOE*  message.
...
[#_Ref237676489]#Table 8: Security Assurance Requirements#
...
[#_Ref397655544]#Table 9: TOE Optional SFRs and Auditable Events#
...
[#_Ref397655557]#Table 10: Selection-Based SFRs and Auditable Events#
...
//See https://github.com/ND-iTC/Documents/issues/353//
...
// I think this FAU_STG_EXT1.1 stays the same //
...
// Adding a comment per issue 405 https://github.com/ND-iTC/Documents/issues/405 //
// An extended component for FPT_STM is neededin NDcPP because:  ???? //
