...
|*2.2* |*20-Dec-2019* |*_Release for use_*
|*2.1* |*24-Sep-2018* |*_Released for use_*
|*2.0* |*5-May-2017* |*_Released for use_*
...
link:#_Toc456887371[Figure 1: Generalized Distributed TOE Model 16]

link:#_Ref17189087[Figure 2: Non-distributed TOE use case 16]

link:#_Toc456887372[Figure 3: Basic distributed TOE use case 17]

link:#_Ref443655034[Figure 4: Distributed TOE use case with Management Component out of scope 18]

link:#_Toc456887375[Figure 5: Management Component required to fulfil cPP requirements 18]

link:#_Toc456887376[Figure 6: Distributed Network Devices plus Management Component required to fulfil cPP requirements 19]

link:#_Toc456887377[Figure 7: Distributed TOE extended through equivalency argument 19]

link:#_Ref463365882[Figure 8: Unsupported Enterprise Management use case 20]

link:#_Toc456887379[Figure 9: Unsupported use case with Multiple Management Components 21]

link:#_Ref476931288[Figure 10: Distributed TOE registration using channel satisfying FPT_ITT.1 or FTP_ITC.1 22]

link:#_Ref476931310[Figure 11: Distributed TOE registration using channel satisfying FTP_TRP.1/Join 22]

link:#_Ref476931325[Figure 12: Distributed TOE registration without a registration channel 23]

link:#_Toc456887383[Figure 13: Joiner enablement options for Distributed TOEs 23]

link:#_Ref399516751[Figure 14: Protected Communications SFR Architecture 44]

link:#_Ref399517041[Figure 15: Administrator Authentication SFR Architecture 45]

link:#_Toc27125738[Figure 16: Correct Operation SFR Architecture 45]

link:#_Toc27125739[Figure 17: Trusted Update and Audit SFR Architecture 46]

link:#_Ref399850426[Figure 18: Management SFR Architecture 47]

link:#_Ref443496257[Figure 19: Distributed TOE SFR Architecture 47]
...
Under this cPP, NDs may be physical or virtualized. A physical Network Device (pND) consists of Network Device functionality implemented inside a physical chassis with physical network connections. The Network Device functionality may be implemented in hardware, software or both. For pNDs, the TOE encompasses the entire device, including both the Network Device functionality and the physical chassis.

A virtual Network Device (vND) is a software implementation of Network Device functionality that runs inside a virtual machine (VM) on either general purpose or purpose-built hardware. The TOE consists of all software within the VM, in particular, the Network Device functionality and the operating system on which it runs. The Virtualisation System (VS) considered part of the TOE, encompasses the virtual hardware abstraction, the hypervisor or virtual machine manager (VMM), all supporting software and the physical chassis.

Under this cPP, vNDs can be evaluated either as physical or virtualized. To evaluate a vND as a pND means that:

* The VS is considered part of the TOE and must satisfy the relevant SFRs (e.g. by treating hypervisor Administrators as Security Administrators)footnote:[It may be useful to iterate the relevant SFRs in a Security Target to cover properties of the virtualisation software separately.].
...
This cPP does not cover software-only NDs. For the purpose of this document, a software-only ND as Network Device whose functionality is implemented as an application or service running on an operating system. A software-only ND that runs on an operating system inside a VM does not qualify as a vND unless the operating system is considered part of the TOE.
...
[#_Toc456887371 .anchor]### Figure 1: Generalized Distributed TOE Model
...
[#_Ref17189087 .anchor]####Figure 2 : Non-distributed TOE use case
...
[#_Toc456887372 .anchor]####Figure 3: Basic distributed TOE use case
...
[#_Toc456887375 .anchor]####Figure 5: Management Component required to fulfil cPP requirements
...
[#_Toc456887376 .anchor]####Figure 6: Distributed Network Devices plus Management Component required to fulfil cPP requirements
...
[#_Toc456887377 .anchor]####Figure 7: Distributed TOE extended through equivalency argument
...
[#_Ref463365882 .anchor]####Figure 8: Unsupported Enterprise Management use case
...
[#_Toc456887379 .anchor]####Figure 9: Unsupported use case with Multiple Management Components
...
[#_Ref476931288 .anchor]####Figure 10: Distributed TOE registration using channel satisfying FPT_ITT.1 or FTP_ITC.1
...
[#_Ref476931310 .anchor]####Figure 11: Distributed TOE registration using channel satisfying FTP_TRP.1/Join
...
[#_Ref476931325 .anchor]####Figure 12: Distributed TOE registration without a registration channel
...
[#_Toc456887383 .anchor]####Figure 13: Joiner enablement options for Distributed TOEs
...
[#_Ref399516751 .anchor]####Figure 14: Protected Communications SFR Architecture

image:extracted-media/media/arch_2.png[image,width=460,height=312]

[#_Ref399517041 .anchor]####Figure 15: Administrator Authentication SFR Architecture

image:extracted-media/media/arch_3.png[image,width=471,height=202]

[#_Toc27125738 .anchor]####Figure 16: Correct Operation SFR Architecture
...
[#_Toc27125739 .anchor]####Figure 17: Trusted Update and Audit SFR Architecture

image:extracted-media/media/arch_6.png[image,width=591,height=304]

[#_Ref399850426 .anchor]####Figure 18: Management SFR Architecture

image:extracted-media/media/arch_7.png[image,width=686,height=339]

[#_Ref443496257 .anchor]####Figure 19: Distributed TOE SFR Architecture
