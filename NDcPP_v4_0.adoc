...
|FAU_STG_EXT.5 |Counting lost audit data |Feature Dependent
|FAU_STG_EXT.4 |Action in case of possible audit data loss |Feature Dependent
|FAU_STG_EXT.2 |Protected local audit data storage for distributed TOEs |Feature Dependent
|FAU_STG_EXT.2 |Protected remote audit data storage for distributed TOEs |Feature Dependent
...
*FAU_STG.1.1* The TSF shall be able to store generated audit data on the [selection: TOE itself, transmit
...
*FAU_STG.2.2* The TSF shall be able to +++<u>+++prevent+++</u>+++ unauthorized
modifications to the stored audit data in the audit trail.

=====  FAU_STG_EXT.4 Counting lost audit data

*FAU_STG_EXT.4 Counting lost audit data*

*FAU_STG_EXT.4.1* The TSF shall provide information about the number of [selection: _dropped, overwritten, [assignment: other information]_] audit records in the case where the local storage has been filled and the TSF takes one of the actions defined in FAU_STG_EXT.1.5.
...
// FCS_STG_EXT.1.5 becomes FAU_STG.5//

===== FAU_STG_EXT.2 Protected local audit event storage for distributed TOEs
...
===== FAU_STG_EXT.5 Protected remote audit data storage for distributed TOEs
