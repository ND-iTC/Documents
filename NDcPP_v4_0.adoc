...
The supporting document defines the evaluation methods and activities for this cPP and has been developed in accordance [CC4]which can be found at https://github.com/ND-iTC/Documents.
