...
*RSASSA-PKCS1-v1_5 or RSASSA-PSS*
...
===== TSS
[arabic, start=131]
. The evaluator shall examine the TSS to determine that it specifies the cryptographic algorithm and key size supported by the TOE for signature verification services.

===== Guidance Documentation
[arabic, start=132]
. The evaluator shall verify that the AGD guidance instructs the administrator how to configure the TOE to use the selected cryptographic algorithm and key size defined in the Security Target supported by the TOE for signature verification services.

===== Tests

*_ECDSA FIPS 186-5 Signature Verification Test_*
[arabic, start=133]
...
|===
[arabic, start=429]
. Note that additional Evaluation Activities for the TSS in the case of a distributed TOE are defined in Annex B.4.1.1.
...
[#_Toc473308377]_Table 1: Mapping of ADV_FSP.1 CEM Work Units to Evaluation Activities_
...
. Note that additional EAs for the guidance documentation in the case of a distributed TOE are defined in Annex B.4.2.1.
...
. Note that additional Evaluation Activities relating to evaluator testing in the case of a distributed TOE are defined in Annex B.4.3.1.
...
[#_Ref453153408]_Table 2: Mapping of AVA_VAN.1 CEM Work Units to Evaluation Activities_
...
[#_Toc412821715]_Table 3: Evaluation Equivalency Analysis_
